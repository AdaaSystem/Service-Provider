...
namespace Adaa\Service;

use Illuminate\Support\ServiceProvider;
use Adaa\Service\Console\Commands\MigrateStatusCommand;
use Adaa\Service\Middleware\ServiceMiddleware;

class AdaaServiceProvider extends ServiceProvider
{
    /**
